  ...
  <div className="bg-black" style={{maxHeight:"100%"}}>
    <Box maxWidth={"80%"}>
      <CardContent style={{padding:"2rem"}}>
        <Typography gutterBottom variant="h2" component="div" style={{color: "rgb(255,95, 0)",}}>
          Problem
        </Typography>
